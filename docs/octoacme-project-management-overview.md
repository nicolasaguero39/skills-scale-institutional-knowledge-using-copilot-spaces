...
For detailed role descriptions and interaction patterns, see [Roles and Personas](./octoacme-roles-and-personas.md) and [Role Interaction Guide](./octoacme-role-interaction-guide.md).
